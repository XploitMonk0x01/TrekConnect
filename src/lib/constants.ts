...
export const AUTH_SIGNIN_NAV_ITEM: NavItem = {
  href: '/auth/signin',
  label: 'Sign In',
  icon: LogIn,
  matchSegments: 2,
}
export const AUTH_SIGNUP_NAV_ITEM: NavItem = {
  href: '/auth/signup',
  label: 'Sign Up',
  icon: UserCircle,
  matchSegments: 2,
}
export const AUTH_SIGNOUT_NAV_ITEM: NavItem = {
  href: '/auth/signin',
  label: 'Sign Out',
  icon: LogOut,
  matchSegments: 0,
} // href to signin after signout

export const APP_NAME = 'TrekConnect'
export const APP_DESCRIPTION =
  'Connect with fellow trekkers and explore new horizons.'

export const PLACEHOLDER_IMAGE_URL = (width: number, height: number) =>
